...
[![github release version](https://img.shields.io/github/v/release/natorus87/tui.editor.svg?include_prereleases)](https://github.com/natorus87/tui.editor/releases/latest) [![npm version](https://img.shields.io/npm/v/@licium/editor.svg)](https://www.npmjs.com/package/@licium/editor) [![license](https://img.shields.io/github/license/natorus87/tui.editor.svg)](https://github.com/natorus87/tui.editor/blob/master/LICENSE) [![PRs welcome](https://img.shields.io/badge/PRs-welcome-ff69b4.svg)](https://github.com/natorus87/tui.editor/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) [![code with hearth by NHN Cloud](https://img.shields.io/badge/%3C%2F%3E%20with%20%E2%99%A5%20by-NHN_Cloud-ff1414.svg)](https://github.com/nhn)
...
| Name | Description |
| --- | --- |
| [`@licium/editor`](https://github.com/natorus87/tui.editor/tree/master/apps/editor) | Plain JavaScript component |

### TOAST UI Editor's Wrappers

| Name | Description |
| --- | --- |
| [`@licium/react-editor`](https://github.com/natorus87/tui.editor/tree/master/apps/react-editor) | [React](https://reactjs.org/) wrapper component |
| [`@licium/vue-editor`](https://github.com/natorus87/tui.editor/tree/master/apps/vue-editor) | [Vue](https://vuejs.org/) wrapper component |

### TOAST UI Editor's Plugins

| Name | Description |
| --- | --- |
| [`@licium/editor-plugin-chart`](https://github.com/natorus87/tui.editor/tree/master/plugins/chart) | Plugin to render chart |
| [`@licium/editor-plugin-code-syntax-highlight`](https://github.com/natorus87/tui.editor/tree/master/plugins/code-syntax-highlight) | Plugin to highlight code syntax |
| [`@licium/editor-plugin-color-syntax`](https://github.com/natorus87/tui.editor/tree/master/plugins/color-syntax) | Plugin to color editing text |
| [`@licium/editor-plugin-table-merged-cell`](https://github.com/natorus87/tui.editor/tree/master/plugins/table-merged-cell) | Plugin to merge table columns |
| [`@licium/editor-plugin-uml`](https://github.com/natorus87/tui.editor/tree/master/plugins/uml) | Plugin to render UML |
...
* [**`chart`**](https://github.com/natorus87/tui.editor/tree/master/plugins/chart) : A code block marked as a 'chart' will render [TOAST UI Chart](https://github.com/nhn/tui.chart).
* [**`code-syntax-highlight`**](https://github.com/natorus87/tui.editor/tree/master/plugins/code-syntax-highlight) : Highlight the code block area corresponding to the language provided by [Prism.js](https://prismjs.com/).
* [**`color-syntax`**](https://github.com/natorus87/tui.editor/tree/master/plugins/color-syntax) : 
...
* [**`table-merged-cell`**](https://github.com/natorus87/tui.editor/tree/master/plugins/table-merged-cell) : 
You can merge columns of the table header and body area.
* [**`uml`**](https://github.com/natorus87/tui.editor/tree/master/plugins/uml) : A code block marked as an 'uml' will render [UML diagrams](http://plantuml.com/screenshot).

## 🎨 Features

* [Viewer](https://github.com/natorus87/tui.editor/tree/master/docs/en/viewer.md) : Supports a mode to display only markdown data without an editing area.
* [Internationalization (i18n)](https://github.com/natorus87/tui.editor/tree/master/docs/en/i18n.md) : Supports English, Dutch, Korean, Japanese, Chinese, Spanish, German, Russian, French, Ukrainian, Turkish, Finnish, Czech, Arabic, Polish, Galician, Swedish, Italian, Norwegian, Croatian + language and you can extend.
* [Widget](https://github.com/natorus87/tui.editor/tree/master/docs/en/widget.md) : This feature allows you to configure the rules that replaces the string matching to a specific `RegExp` with the widget node.
* [Custom Block](https://github.com/natorus87/tui.editor/tree/master/docs/en/custom-block.md) : Nodes not supported by Markdown can be defined through custom block. You can display the node what you want through writing the parsing logic with custom block.
...
* [Code of Conduct](https://github.com/natorus87/tui.editor/blob/master/CODE_OF_CONDUCT.md)
* [Contributing Guideline](https://github.com/natorus87/tui.editor/blob/master/CONTRIBUTING.md)
* [Commit Convention](https://github.com/natorus87/tui.editor/blob/master/docs/COMMIT_MESSAGE_CONVENTION.md)
* [Issue Guidelines](https://github.com/natorus87/tui.editor/tree/master/.github/ISSUE_TEMPLATE)
...
This software is licensed under the [MIT](https://github.com/natorus87/tui.editor/blob/master/LICENSE) © [NHN Cloud](https://github.com/nhn).
